...
import '../../l10n/locale_provider.dart' as _i6;
import '../../presentation/utils/language_detection_service.dart' as _i5;
...
_i1.GetIt $configureDependencies(
  ...
  gh.singleton<_i5.LanguageDetectionService>(
      () => languageDetectionModule.languageDetectionService);
  gh.singleton<_i6.LocaleProvider>(() => localeProviderModule.localeProvider);
